...
/*
Plugin Name: 韵达速递
Plugin URI: http://www.ecjia.com/plugins/ecjia.yunda/
...
class plugin_ship_yunda {

    public static function install() {
        $config = include(RC_Plugin::plugin_dir_path(__FILE__) . 'config.php');
        $config['print_bg'] = Ecjia_PluginManager::driver('ship_yunda')->defaultPrintBackgroundImage();
        $config['config_lable'] = Ecjia_PluginManager::driver('ship_yunda')->getConfigLabel();
...
RC_Plugin::register_activation_hook(__FILE__, array('plugin_ship_yunda', 'install'));
RC_Plugin::register_deactivation_hook(__FILE__, array('plugin_ship_yunda', 'uninstall'));
